...
import bg from "./images/scene-bg.jpg";
...
animationScripts.push({
  ...
  func() {
    camera.lookAt(box.position);
    camera.position.set(0, 1, 10);
    box.rotation.z = lerp(1, Math.PI * 2, scalePercent(this.start, this.end));
  }
});
...
document.body.onscroll = () => {
  ...
  scrollParcent = ( scrollTop / (scrollHeight - browserHeight)) * 100;
}
